...
export function ConflictBanner({ conflict }: ConflictBannerProps) {
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-2 bg-red-50 dark:bg-red-950/60 border-b border-red-200 dark:border-red-800 text-sm shrink-0">
      <span className="text-red-500 dark:text-red-400 font-medium shrink-0">⚠ Conflict</span>
      <span className="text-red-600 dark:text-red-300 flex-1">
